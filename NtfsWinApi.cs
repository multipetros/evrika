/* 
 * Based on Win32Api.cs of MTFScanner <http://archive.codeplex.com/?p=mftscanner> 
    ...
    public class NtfsWinApi{
        ...
        public class UsnEntry : IComparable<UsnEntry>{
            ...
            public bool IsFolder{
                get{
                    bool bRtn = false;
                    if (0 != (_fileAttributes & NtfsWinApi.FILE_ATTRIBUTE_DIRECTORY)){
                        bRtn = true;
                    }
                    return bRtn;
                }
